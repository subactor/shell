...
COMMANDS = (
    ...
    CommandSpec("/supervisor", "[status|observe|cycle|questions|answer]", "status, cykl i odpowiedzi HITL supervisora (bez apply)", "Flota i Autonomia", aliases=("/sup",), handler_id="supervisor"),
